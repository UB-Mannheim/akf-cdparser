/**
 * regexLib.js
 * Contains a set of functions for utility purposes. Mostly string editing. 
 * All functions here have the common feature, that regexes are used for processing the data.
 */
...
/**
 * Check if a defined string contains a 4-digit year
 * @param {string} line - string to match
 * @returns the matched year
 */
...
/**
 * match content between parenthesis
 * @param {string} data - string to check upon 
 * @returns {array} matched content
 */
 ...
 * @param {string} data - string to check upon 
 * @returns {boolean} - true if ends with ':' otherwise false
 */
function doesEndWithColon(data){
    if(data){
...
/**
 * Removes the last ':' from string
 * @param {string} data - string to edit
 * @returns {string} data without last : 
 */
function removeLastColon(data){
    var returndata = data.replace(/:\s*$/, "");
    return returndata;
}
 ...
 * @param {string} data - string to edit
 * @param {string} char - character which will be removed if at end of string
 * @returns {string} data without last character 
 */
function removeLastCharacter(data,char){
    if(!char)return data;
    var  regex = new RegExp(char+"\s*$"); 
    var returndata = data.replace(regex, "");
    return returndata;
}

/**
 * Remove parenthesis in string
 * @param {string} data data to remove in string
 * @returns {string} data without string 
 */
...
/**
 * Check if a defined character in a string is followed by alphabetic 
 * letters.
 * @param {string} data - string to look upon
 * @param {string} char - character which is defined (default value is '¦')
 * @returns {string} the matched data or null if no data defined
 */
