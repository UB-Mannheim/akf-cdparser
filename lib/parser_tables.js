        ...
        for(var i=0;i<tableAusBilanzen.length;i++){
            ...
            if(i==0){
                ...
                for(var x=0;x<currentColumn.length;x++){
                    ...
                    if(currentItemTextLC.indexOf("bilanzsumme")==-1 
                       && nextItem && nextItem.indexOf("</b>")!=-1){
                    ...
                    }else if(currentItemTextLC.indexOf("davon gezeichnetes kapital")!=-1){
                    ...
                    }else if(currentItemTextLC.indexOf("rückstellungen")!=-1){
                    ...
                    }else if(currentItemTextLC.indexOf("davon über 1 jahr")!=-1){
                    ...
                    }else if(currentItemTextLC.indexOf("pensionsrückstell")!=-1){
                        ...
                        currentItemIndices.passiva.andere_rueckstellungen = x;
                    }else if(currentItemTextLC.indexOf("langfr")!=-1 && currentItemTextLC.indexOf("verbindlichkeiten")!=-1){
                    ...
                    }else if(currentItemTextLC.indexOf("kurzfr")!=-1 && currentItemTextLC.indexOf("verbindlichkeiten")!=-1){
