...
/**
 * Writes the current workbook, which is defined in module-scope
 * to a excelfile. The filename of the excelfile is defined by
 * PRINT_FILENAME+PRINT_NAME+PRINT_ENDING. 
 */
function writeToExcelFile(){   
 ...
 /**
  * Creates the current workbook with  creation and modification  date, 
  * as well as the table defined in module-scope variable 'sheetID'
  */
