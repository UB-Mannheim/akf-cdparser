    ...
    */
    ...
    for(var i=0;i<_sectorsHolder.length;i++){
        ...
        for(var x=0;x<sortedColumn.length;x++){
            ...
            editExcelCell(currentItem.ctr,worksheet,rowIndex,sectorKey,borders);
            ...
            editExcelCell(currentItem.isGroup,worksheet,rowIndex,sectorKey,borders);
 ...
 * @param {*} borders 
 */
function editExcelCell(value,worksheet,rowNumber,columnID,borders=null){
    var row = null;
