        ...
        this._parseFunctions = [
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    } while (!lines[i] && !(lines[i].match('<b>Sitz</b>')))
                    all_wkn_entry.push({type, isin, wkn, nw});
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var organbezuege = parser_organbezuege.parseOrganbezuege(organbezuege,originline,i,ret);
                    if(organbezuege){
                        if(!ret.organbezuege) ret.organbezuege = [];
                        ret.organbezuege.push(organbezuege);
                    }
                    return i; 
                }
            },
