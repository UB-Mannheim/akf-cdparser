            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    do{
                        ...
                        if(!currentline){ 
                            //currentLineDefined = false; 
                            currentline = "__"; //Some arbitrary value which isn't checked
                        }

                        var pushc = currentline.substr(0,4)!="<br>";
                        var end1 = currentline.indexOf("<br><center>")!=-1;

                        if(pushc && currentline.length>=6){
                            linesAktionaer.push(currentline);
                        }
                        var end2 = currentline.indexOf("</body>")!=-1; 
