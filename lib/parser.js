...
module.exports = class CdHtmlParser {
        ...
        this._parseFunctions = [
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    }while(end==-1 && end2==-1 && end3==-1 && end4==-1) 
                    i=i-1;
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    do{
                        ...
                        var end2 = currentline.indexOf("<br><b>Dividenden");
                    }while(end==-1 && end2==-1) 
    ...
    parseFile(filename) {
        ...
        cfw.writeHeaderToCheckFile(filename+"-----------------------------",cfw.config.checkfile_bereinigtekurse,cfw.config.checkfile_bereinigtekurse_enabled);
