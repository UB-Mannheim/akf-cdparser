        ...
        this._parseFunctions = [
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var retKennzahlen = parser_tables.parse_aus_bilanzen(tablesParsed,tablesArr,rest,infos);

                    cfw.writeToCheckfile(originline,JSON.stringify(tablesArr, null, " "),JSON.stringify(retKennzahlen, null, " "),cfw.config.checkfile_aus_bilanzen,cfw.config.checkfile_aus_bilanzen_enabled);
