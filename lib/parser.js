...
const checkfile_organbezuege_enabled = true; 
const checkfile_organbezuege ="Checkfile_Organbezuege.txt"; 
...
fs.writeFileSync(checkfile_organbezuege,'');
...
module.exports = class CdHtmlParser {
    ...
    constructor() {
        this._parseFunctions = [
            ...
            {
                /** 
                 * Remark some lines are parsed directly in 'bemerkung' when there is  vaöid currency
                 * Vorstand 1996: keine Angaben gem. § 286 Abs. 4 HGB;
                ...
                fn: (lines, i, ret) => {
                    ...
                    //writeHeaderToCheckFile(lineBRsplit,checkfile_organbezuege,checkfile_organbezuege_enabled);
                    ...
                    for(var x=0;x<lineBRsplice.length; x++){
                       ...
                       writeHeaderToCheckFile(organbezuege,checkfile_organbezuege,checkfile_organbezuege_enabled);
                    }
                    i += 1      
                    ret.organbezuege = []
                    ...
                    organbezuege.split(/\s*;\s*/).trimAll().forEach(_ => {      
                        ...
                        writeToCheckfile(originline,_,JSON.stringify(organbezug), checkfile_organbezuege ,checkfile_organbezuege_enabled);                                        
    ...
    parseFile(filename) {
        ...
        writeHeaderToCheckFile(filename+"-----------------------------",checkfile_organbezuege,checkfile_organbezuege_enabled);
