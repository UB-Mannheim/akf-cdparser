        ...
        this._parseFunctions = [
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var retKapitalEntwicklung = parser_tables.parse_kapitalEntwicklung(tablesParsed);
                    var retGrundkapital = parser_tables.parse_grundkapital(tablesParsed,tablesArr,rest,infos);
