        ...
        this._parseFunctions = [
            ...
            // TODO: Control the matching its copied of Investor Relations
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    if(linesPublicR.length==1){
                        var linesBRSplit = linesPublicrR[0].split('<br>');
                        var lineBRsplice = linesBRSplit.splice(1);   //Cutout the first line  
                    ...
                    i += 1;
                    var restoflines = parser_persons.parse_investorRelations(investorPubLinesFinal,originline,i,ret);
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var retKennzahlen = parser_tables.parse_kennzahlen(tablesParsed,tablesArr,rest,infos);
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var retAusBilanzen = parser_tables.parse_aus_bilanzen(tablesParsed,tablesArr,rest,infos);
                    ...
                    ret.ausBilanzen = retAusBilanzen;
            ...
            },
            {
                ...
                fn: (lines, i, ret) => {
                    ...
                    var retAusGewinnUndVerlust = parser_tables.parse_aus_gewinn_und_verlustrechnungen(tablesParsed,tablesArr,rest,infos);
                    ...
                    ret.ausGewinnUndVerlust = retAusGewinnUndVerlust;
