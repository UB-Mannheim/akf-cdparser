 ...
 * @param {string} data to check if it's a funct 
 * @param {object} options for matching, currently unused, see checkIfaTitleIsInAString for implementation example  
 * @returns {object} true if it's a function, false if not; rest of data as a string, boolean indicator if there is a rest; title found
 */
